...
Route::group(['middleware'=>'auth:sanctum','prefix'=>'admin','as'=>'admin.'],function (){
    ...
    Route::group(['prefix'=>'subcategories','as'=>'subcategory.'],function (){
        ...
        Route::delete('/{subcategory}/operation',[SubCategoryController::class,'remove_operation'])->name('remove_operation');
...
Route::group(['prefix'=>'guest','as'=>'guest.'],function (){
   ...
   Route::post('/newsletter',[GuestController::class,'subscribe_newsletter'])->name('subscribe');
